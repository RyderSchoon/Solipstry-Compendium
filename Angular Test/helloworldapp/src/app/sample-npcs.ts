...
export const NPCS: NPC[] = [
    ...
    { name: '', level: 1, attack: "+1", initiative: "+2", move: 5, AC: 14, will: 11, reflex: 11, fortitude: 13, npcversion: "1", npcauthor: "Anonymous", isHomebrew: true, imageSrc: "https://solipstry.com/Solipstry%20Logo.png" }
];